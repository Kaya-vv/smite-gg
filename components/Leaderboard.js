...
import useSmite from "../hooks/useSmite";
...
function Leaderboard({ playerArray, session }) {
  ...
  return (
    <div
      id="leaderboard-page"
      className=" w-full lg:w-5/6 flex my-[60px] mx-auto"
    >
      <div
        id="content-container"
        className=" w-full flex-grow h-full box-content px-6"
      >
        <h1 className="text-3xl font-semibold text-white m-0">Leaderboards</h1>
        <Topfive
          players={topFive}
          session={session}
        ...
        {loading ? (
          ...
          <>
            <div
              id="table"
              className="flex flex-col flex-1 w-full mt-7 px-6 overflow-hidden rounded-md bg-[#191937] text-[#cddcfe] font-medium text-sm "
            >
              <Ranking
